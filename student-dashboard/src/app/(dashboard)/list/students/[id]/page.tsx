        ...
        <div className='flex xl:flex-row flex-col flex-1 gap-4 p-4'>
            ...
            <div className="w-full xl:w-2/3">
                ...
                <div className="flex lg:flex-row flex-col gap-4">
                    ...
                    <div className="flex flex-1 gap-4 bg-janSky px-4 p-6 rounded-md">
                        <div className="w-1/3">
                            <Image src="https://images.pexels.com/photos/5414817/pexels-photo-5414817.jpeg?auto=compress&cs=tinysrgb&w=1200 " alt='' width={144} height={144} className='rounded-full w-36 h-36 object-cover' />
                        </div>
                        <div className="flex flex-col justify-between gap-4 w-2/3">
                            <h1 className='font-semibold text-xl'>Jerry Higgins</h1>
            ...
            <div className="bg-white p-4 rounded-md">
                ...
                <div className="flex flex-wrap gap-4 mt-4 text-gray-500 text-sm">
                    <Link className='bg-janSkyLight p-3 rounded-md' href="/">Students's Lessons</Link>
                    <Link className='bg-janPurpleLight p-3 rounded-md' href="/">Students's Teachers</Link>
                    <Link className='bg-pink-50 p-3 rounded-md' href="/">Students's Exams</Link>
                    <Link className='bg-lime-50 p-3 rounded-md' href="/">Students's Assignments</Link>
                    <Link className='bg-janYellowLight p-3 rounded-md' href="/">Students's Results</Link>
                </div>
            </div>
            <Performance/>
            <Annoncements/>
